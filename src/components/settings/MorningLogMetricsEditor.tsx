...
export function MorningLogMetricsEditor(props: MorningLogMetricsEditorProps) {
  return (
    <LogMetricsEditor
      ...
      description="Add metrics from your Metrics page to include in the morning log. New metrics you track appear in the add menu automatically."
      emptyConfiguredHint="No morning log fields yet. Add metrics on the Metrics page first, then add them here."
      emptyAddableHint="All tracked metrics are already in your morning log. Add more on the Metrics page."
